...
public class AdminTicketStockController {
    ...
    public ApiResponse<AdminStockVO> initStock(@PathVariable Long ticketCategoryId,
        ...
        return ApiResponse.successZero(adminBusinessService.initStock(ticketCategoryId, body));
    }
    ...
    public ApiResponse<AdminStockVO> preheatStock(@PathVariable Long ticketCategoryId) {
        return ApiResponse.successZero(adminBusinessService.preheatStock(ticketCategoryId));
    }

    @PostMapping("/stocks/preheat-all")
    public ApiResponse<List<AdminStockVO>> preheatAllStock() {
        return ApiResponse.successZero(adminBusinessService.preheatAllStock());
    }
